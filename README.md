...
## Disadvantage
For time limit, I didn't make one task manager can ask to buy same product. If want to do this, I just need rewrite the hashCode function or give one more attribute of quantity in hashmap. Temporarily hashCode is :
```java
